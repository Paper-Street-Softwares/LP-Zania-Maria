export default function IconFeatureCard(props) {
  ...
  return (
    <div
      className={`w-full tablet1:min-h-[280px] p-0 tablet1:w-[250px] mt-[36px] tablet1:mt-0 desktop1:w-[250px] desktop1:h-[350px] flex flex-col items-center desktop1:hover:scale-110 transition desktop1:p-0 ${className}`}
    >
      <div
      ...
      <h1
        className={`h-auto font-bold font-mainFont text-title2 text-center mb-[16px] ${textClass}`}
      >
        {title}
      </h1>
      <p
